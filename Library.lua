...
function Library.sections:Toggle(options)
    ...
    function Toggle:Colorpicker(options)
        ...
        UserInputService.InputChanged:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch and SlidingPalette or SlidingAlpha or SlidingHue then
                SetState()
            end
        end)
